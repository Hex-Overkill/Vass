...
print(f"{Colors.RED}__     ___    ____ ____       ____  _   {Colors.RESET}")
print(f"{Colors.RED}\ \   / / \  / ___/ ___|     / ___|| |     {Colors.RESET}")
print(f"{Colors.RED} \ \ / / _ \ \___ \___ \     \___ \| |     {Colors.RESET}")
print(f"{Colors.RED}  \ V / ___ \ ___) |__) )     |__) | |___ {Colors.RESET}")
print(f"{Colors.RED}   \_/_/   \_\____/____/     |____/|_____|{Colors.RESET}")
print('')
print(f"{Colors.YELLOW}MADE BY CYBERHUB ACADEMY SL {Colors.RESET}")
print('')
print(f"{Colors.YELLOW}PROFESSOR & HEX_OVERKIILL{Colors.RESET}")
print('')
